...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 02 2021 г., 10:27
...
(1, '12', 'Да', NULL, NULL, 'Муж', NULL, NULL, 'Очная', NULL, NULL, 'Медицина', 'Казань', 'Да', 'Да', 'Да', 'Да', NULL, '300');
...
(1, 'age', '35', 'stepen', 'Аспирантура', 'forma', 'Очная', 'false'),
(2, 'gender', 'Муж', 'is_licei', 'Да', 'type', 'Военное училище', 'true');
...
INSERT INTO `objects` (`id`, `name`, `type`, `forma`, `naprav`, `city`, `is_home`, `is_active`, `is_lgoti`, `budget`, `ball`) VALUES
(1, 'Московский Политех', 'Вуз', 'Очная', 'Информатика', 'Москва', 'Да', 'Нет', 'Да', '200', '250'),
(2, 'МГТУ им. Н. Э. Баумана', 'Вуз', 'Очная', 'Информатика', 'Москва', 'Да', 'Нет', 'Да', '200', '200'),
(3, 'Колледж Архитектуры, Дизайна и Реинжиниринга № 26', 'Колледж', 'Очно-Заочная', 'Строительство', 'Москва', 'Нет', 'Нет', 'Нет', '200', '250'),
(4, 'Казанское высшее танковое командное Ордена Жукова Краснознаменное училище', 'Военное училище', 'Очная', 'Медицина', 'Казань', 'Да', 'Да', 'Да', '200', '200');
...
(2, 'is_licei', 'Да', 'type', 'Лицей/Училище', 'true'),
...
(9, 'gender', 'Муж', 'gender', 'Муж', 'true'),
(10, 'gender', 'Жен', 'gender', 'Жен', 'false'),
(11, 'forma', 'Очная', 'forma', 'Очная', 'false'),
...
(16, 'forma2', 'Очная', 'forma', 'Очная', 'true'),
...
(26, 'naprav', 'Медицина', 'naprav', 'Медицина', 'true'),
...
(47, 'stepen', 'Бакалавриат', 'type', 'Вуз', 'false'),
(48, 'stepen', 'Специалитет', 'type', 'Вуз', 'false'),
(49, 'stepen', 'Магистратура', 'type', 'Вуз', 'false'),
(50, 'stepen', 'Аспирантура', 'type', 'Вуз', 'false');
