...
--
-- Хост: 127.0.0.1
-- Время создания: Ноя 17 2021 г., 17:57
...
CREATE TABLE `answers` (
  ...
  `isLicei` varchar(255) DEFAULT NULL,
  `stepen` varchar(255) DEFAULT NULL,
  `isColledge` varchar(255) DEFAULT NULL,
  `gender` varchar(255) DEFAULT NULL,
  `forma1` varchar(255) DEFAULT NULL,
  ...
  `isLgoti` varchar(255) DEFAULT NULL,
  `isBudget` varchar(255) DEFAULT NULL,
  `budget` varchar(255) DEFAULT NULL,
  `ball` varchar(255) DEFAULT NULL,
  `is_licei` varchar(191) DEFAULT NULL,
  `is_home` varchar(191) DEFAULT NULL,
  `is_active` varchar(191) DEFAULT NULL,
  `is_lgoti` varchar(191) DEFAULT NULL,
  `is_budget` varchar(191) DEFAULT NULL,
  `is_colledge` varchar(191) DEFAULT NULL
...
INSERT INTO `answers` (`id`, `age`, `isLicei`, `stepen`, `isColledge`, `gender`, `forma1`, `sovet`, `forma2`, `subjects`, `vstypit`, `naprav`, `city`, `isHome`, `isActive`, `isLgoti`, `isBudget`, `budget`, `ball`, `is_licei`, `is_home`, `is_active`, `is_lgoti`, `is_budget`, `is_colledge`) VALUES
(1, '18', NULL, 'Специалитет', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(13, 'Нужно ли вам место проживания?', 2, 'Да', 'Нет', NULL, NULL, 'isHome', 14),
(14, 'Наличие активной внеучебной деятельности?', 2, 'Да', 'Нет', NULL, NULL, 'isActive', 15),
(15, 'Имеются ли льготы?', 2, 'Да', 'Нет', NULL, NULL, 'isLgoti', 16),
(16, 'Рассматриваете только бюджет?', 2, 'Да', 'Нет', NULL, NULL, 'isBudget', 17),
